        ...
        @if (!empty($pesanan))
            ...
            <div>
                <div class="text-right pr-4 pb-4">
                    <a href="{{ url('admin/pesanan-dibayar') }}" class="btn btn-secondary"><i class="fa fa-arrow-left"></i>
                        Kembali</a>
                    <a href="#" class="btn btn-success"
                        onclick="event.preventDefault(); document.getElementById('kirim').submit();"><i
                            class="fa fa-check"></i> Pesanan Dikirim</a>

                    <form id="kirim" action="{{ url('admin/pesanan-dibayar') }}/{{ $pesanan->id }}" method="post">
                        @csrf
